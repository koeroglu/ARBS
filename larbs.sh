...
[ -z "$dotfilesrepo" ] && dotfilesrepo="hthttps://github.com/koeroglu/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/koeroglu/LARBS/master/progs.csv"
